...
/**
 * Add line-level discount, tax, and ordering columns to purchase_return_items.
 *
 * This aligns purchase_return_items with bill_items structure,
 * enabling proper data preservation when creating returns from bills.
 */
