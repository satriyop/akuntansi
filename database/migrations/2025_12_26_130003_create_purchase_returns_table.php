...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_returns', function (Blueprint $table) {
            $table->id();
            $table->string('return_number')->unique(); // PR-YYYYMM-NNNN
            ...
            $table->string('reason')->nullable(); // damaged, wrong_item, quality_issue, excess_quantity, etc.
            ...
            $table->foreignId('debit_note_id')->nullable()->constrained('bills')->onDelete('set null'); // Debit note (negative bill)
