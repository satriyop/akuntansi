...
/**
 * Add line-level discount, tax, and ordering columns to bill_items.
 *
 * This aligns bill_items with purchase_order_items,
 * enabling proper data preservation when converting POs to bills.
 *
 * Changes:
